...
| 2026-08-22T20:27:39Z | [#412](https://github.com/LibraVault/reader/pull/412) | feat(android): full Player-screen parity for Read Aloud (TTS) | escalated (circuit breaker) | `status:needs-info` applied 4 times over its lifetime — pulled out of the automated loop, relabeled `status:escalated` for direct human attention. |
