...
///
/// Vendored verbatim from k2-fsa/sherpa-onnx (Apache-2.0), path:
/// swift-api-examples/SherpaOnnx.swift @ v1.13.4
/// https://github.com/k2-fsa/sherpa-onnx/blob/v1.13.4/swift-api-examples/SherpaOnnx.swift
///
/// This is the C-API binding layer over the native libraries in
/// sherpa-onnx.xcframework / onnxruntime.xcframework, fetched at build time
/// by third-party/sherpa-onnx/setup-ios.sh (not committed - see
/// SHERPA_ONNX_SETUP.md). Reached via the bridging header
/// (SherpaOnnx-Bridging-Header.h), not a Clang module import - this file
/// covers every sherpa-onnx feature family (ASR/VAD/etc), most of which
/// LibraVault doesn't use; kept whole rather than trimmed to the TTS-only
/// subset so future upstream updates stay a simple file replace, matching
/// the same choice made for the Android vendored Tts.kt (core/tts/.../pocket/sherpa/).
/// Only PocketTTSEngine.swift's usage (VITS TTS) is exercised in this app.
